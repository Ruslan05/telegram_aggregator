...
url = 'https://api.vk.com/method/wall.get?owner_id=-107886736&domain=&offset=4&count=1&filter=owner&extended=1&access_token=686d71abecb677cfa89dea57c24b483e1192687ce78bbd92b4f6ccf059fda1458af809bdf134d8fe35126'
textResponse = requests.get(url).text
jsonResponse = json.loads(textResponse)

filePath = '/home/pi/Desktop/architecture_aggretator/latest_post_date.txt'
